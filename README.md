...
- UI组件库: [antd 4.0.0-alpha.9](https://ant.design/index-cn)
- TS版本: [typescript 3.7.2](https://www.typescriptlang.org/)
...
- JS代码转换: [@babel/core 7.7.2](https://babeljs.io)
- 代码风格约束: [eslint 6.6.0](https://eslint.org)
- HTTP请求框架: [whatwg-fetch 2.0.3](https://www.npmjs.com/package/whatwg-fetch)
- 时间格式化: [moment 2.24.0](http://momentjs.cn)
- 热模块替换: [react-hot-loader 4.12.17](https://www.npmjs.com/package/react-hot-loader)
